...
ui_print " Mobile Legends, Black Desert Mobile etc"
...
ui_print ""
sleep 0.2
ui_print " 1. Asphalt 9 And PUBG Mobile  "
sleep 0.2
...
#
case $GU in
 1 ) TEXT3="✓ASPHALT And PUBGM "; FCTEXT="Asphalt 9 And PUBG Mobile"; sed -i '/ro.product.model/s/.*/ro.product.model=ZS673KS-1A043IN/' $MODPATH/system.prop; sed -i '/ro.product.odm.model/s/.*/ro.product.odm.model=ZS673KS-1A043IN/' $MODPATH/system.prop; sed -i '/ro.product.system.model/s/.*/ro.product.system.model=ZS673KS-1A043IN/' $MODPATH/system.prop; sed -i '/ro.product.vendor.model/s/.*/ro.product.vendor.model=ZS673KS-1A043IN/' $MODPATH/system.prop; sed -i '/ro.product.system_ext.model/s/.*/ro.product.system_ext.model=ZS673KS-1A043IN/' $MODPATH/system.prop;;
